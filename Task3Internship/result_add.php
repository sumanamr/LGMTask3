            ...
            <div class="info">
                ...
                <div class="add-class res">
                    ...
                    <form action="" method="post">
                        ...
                        <input class="sub-input" type="text" name="subject6" placeholder="Enter Subject Name">
                        <input class="marks-input" type="number" name="marks6" placeholder="Marks">
...
if (isset($_POST['Roll'])) {
    ...
    $classId = $sql2['id'];
    $name_check = null;
    $name_sql = mysqli_query($conn, "SELECT `name` FROM `students` WHERE `roll_no`='$roll' AND `class_id`='$classId'");
    ...
    $sql = "INSERT INTO `results`(`roll_no`, `class`, `sub1`, `marks1`, `sub2`, `marks2`, `sub3`, `marks3`, `sub4`, `marks4`, `sub5`, `marks5`,`sub6`,`marks6`) VALUES ('$roll','$class','$s1','$m1','$s2','$m2','$s3','$m3','$s4','$m4','$s5','$m5','$s6','$m6')";
